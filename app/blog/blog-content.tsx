        ...
        const mapped = list.map((b: any) => ({
          ...
          excerpt:
            typeof b.excerpt === "string"
              ? b.excerpt
              : b.excerpt?.ar || b.excerpt?.en || "",
          slug: b.slug,
          image: b.coverImage || b.image || "/placeholder.svg",
          publishDate: new Date(
            b.createdAt || b.publishedAt || Date.now()
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        {error && !loading && (
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-red-600 mb-2 arabic-text">
              حدث خطأ في التحميل
            </h3>
            ...
            {filteredArticles.map((article, index) => (
              ...
              >
                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex flex-wrap gap-1 mb-4">
                    {article.tags.slice(0, 2).map((tag, idx) => (
                      <Badge
                        key={idx}
                        variant="secondary"
                        className="text-xs bg-gray-100 text-gray-600 hover:bg-gray-200 arabic-text"
                      >
                        {tag}
                      </Badge>
                    ))}
                  ...
                  <Button
                    asChild
                    className="w-full bg-gradient-to-r from-purple-700 to-purple-900 hover:from-purple-600 hover:to-purple-800 border-0 rounded-xl transition-all duration-300 hover:shadow-md arabic-text "
                  >
                    <Link
                    ...
                    >
                      ...
                      <ArrowLeft
                        className="h-4 w-4 rtl-flip group-hover:translate-x-1 transition-transform duration-300"
                        style={{ color: "#fff !important" }}
                      />
                    </Link>
                  </Button>
