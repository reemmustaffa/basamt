...
export const metadata = {
  title:
    "خدماتنا | بصمة تصميم - تصميم الهوية البصرية والسوشيال ميديا والمحتوى الرقمي",
  description:
    "اكتشف مجموعة خدماتنا الإبداعية في التصميم والمحتوى والهوية البصرية. خدمات تصميم الشعارات، إدارة السوشيال ميديا، تصميم البنرات الإعلانية، والمحتوى الرقمي الاحترافي في السعودية.",
  keywords: [
    "خدمات التصميم",
  ...
  twitter: {
    ...
    title:
      "خدماتنا | بصمة تصميم - تصميم الهوية البصرية والسوشيال ميديا والمحتوى الرقمي",
    description:
      "اكتشف مجموعة خدماتنا الإبداعية في التصميم والمحتوى والهوية البصرية.",
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-16 relative z-20">
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-primary mb-6 arabic-text">
            خدماتنا المتميزة
          </h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto arabic-text leading-relaxed">
            نقدم مجموعة شاملة من الخدمات المتخصصة في التصميم والتطوير لمساعدتك
            في تحقيق أهدافك الرقمية
          </p>
        </div>
