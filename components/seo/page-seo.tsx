...
export const seoConfigs = {
  ...
  about: {
    ...
    description:
      "تعرف على بصمة تصميم وفريق العمل المبدع. نحن متجر متخصصة في التصميم الجرافيكي والهوية البصرية مع خبرة تزيد عن 5 سنوات في السوق.",
    keywords: [
      "بصمة تصميم",
      "من نحن",
      "فريق العمل",
  ...
  services: {
    ...
    description:
      "خدمات بصمة تصميم الشاملة: تصميم الشعارات، الهوية البصرية، السوشيال ميديا، البنرات الإعلانية، كتابة المحتوى، وتصميم السير الذاتية. جودة احترافية وأسعار تنافسية.",
    keywords: [
      "خدمات تصميم",
      "تصميم شعارات",
      "هوية بصرية",
  ...
  contact: {
    ...
    description:
      "تواصل مع فريق بصمة تصميم للحصول على استشارة مجانية حول مشروعك. نحن هنا لمساعدتك في تحقيق رؤيتك الإبداعية بأفضل الحلول التصميمية.",
    keywords: [
      "تواصل معنا",
      "استشارة مجانية",
      "خدمة العملاء",
  ...
  portfolio: {
    ...
    description:
      "استعرض معرض أعمال بصمة تصميم ومشاريعنا السابقة في تصميم الشعارات والهوية البصرية. أعمال إبداعية متنوعة لعملائنا في مختلف القطاعات.",
    keywords: [
      "معرض الأعمال",
      "مشاريع سابقة",
      "شعارات مصممة",
